...
website +="width:IS0px;text-align:center;margin:0auto;morgin-bottom:30px;font-size:2em;}";
website +=".btnl{bockground-color:black;color:white;}";
website +=".btn2{background-color:white;color:black;}";
website+="</style>";
website +="</head>\n";
website +="<body>";
website +="<hl closs=\"title\''>Remote LED Control</hl>";
website +="<a class=\"btnl\" href=\"/H\">ON</a>";
