...
void buildWeb(){
 ...
 webSite +=  ".title{text-align:center;color:pink;}";
 webSite +=  "a{display:block;text-decoration:none;background-color:lightgreen;}";
 webSite +=  "width:150px;text-align:center;margin:0 auto;margin-bottom:30px;font-size:2em;";
 webSite +=  ".btn1{background-color:black;color:purple;}";
  webSite += ".btn2{background-color:green;color:black;}";
 webSite +=  "</style>";
  webSite += "</head>\n";
 webSite +=  "<body>";
